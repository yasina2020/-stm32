...
void LCD_INIT(void){	//初始化
	...
	LCD_WRITE_CMD( LCD1602A_CMD6 | LCD1602A_CMD6_DL_SET| LCD1602A_CMD6_N_SET ); //cmd6
	LCD_WRITE_CMD( LCD1602A_CMD4 | LCD1602A_CMD4_D_SET |LCD1602A_CMD4_C_SET|LCD1602A_CMD4_B_SET);	//cmd4 ??????±ê?????
	LCD_WRITE_CMD( LCD1602A_CMD3 | LCD1602A_CMD3_ID_SET);  //cmd3
	LCD_WRITE_CMD( LCD1602A_CMD1 );  //cmd1
}
/***********************************LCD初始化********************************************/
...
void LCD_WRITE_StrDATA( char *StrData, unsigned char row, unsigned char col ){//写入字符串
